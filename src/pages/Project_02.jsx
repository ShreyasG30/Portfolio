...
const projectData = {
  ...
  image: `${import.meta.env.BASE_URL}Project_01/Project_01.png`, 
      ...
      <div className="relative z-10 flex flex-col items-start w-full px-2 md:px-8 py-8 max-w-7xl mx-auto">
        ...
        <section className="w-full mb-8 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl shadow-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <ImgCol
              src={`${import.meta.env.BASE_URL}Project_01/Anchor assembly.png`}
              alt="Anchor assembly"
              caption="Figure 1. Anchor assembly"
              onClick={() => handleImgClick(`${import.meta.env.BASE_URL}Project_01/Anchor assembly.png`, "Anchor assembly")}
            />
            <div>
        ...
        <section className="w-full mb-8 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl shadow-lg p-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 items-start">
            <ImgCol
              src={`${import.meta.env.BASE_URL}Project_01/P01_Figure_03.png`}
              alt="Bottom Plate"
              caption="Figure 3. Dimensions of the Bottom Fixed Plate"
              onClick={() => handleImgClick(`${import.meta.env.BASE_URL}Project_01/P01_Figure_03.png`, "Bottom Plate")}
            />
            <ImgCol
              src={`${import.meta.env.BASE_URL}Project_01/P01_Figure_04.png`}
              alt="Bottom Plate Section"
              caption="Figure 3. Dimensions of the Bottom Fixed Plate (Section)"
              onClick={() => handleImgClick(`${import.meta.env.BASE_URL}Project_01/P01_Figure_04.png`, "Bottom Plate Section")}
            />
            <ImgCol
              src={`${import.meta.env.BASE_URL}Project_01/P01_Figure_05.png`}
              alt="Bottom Plate Dimensions"
              caption="Figure 3. Dimensions of the Bottom Fixed Plate (Drawing)"
              onClick={() => handleImgClick(`${import.meta.env.BASE_URL}Project_01/P01_Figure_05.png`, "Bottom Plate Dimensions")}
            />
          </div>
        </section>
        ...
        <section className="w-full mb-8 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl shadow-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-8">
            ...
            <ImgCol
              src={`${import.meta.env.BASE_URL}Project_01/P01_Figure_06.png`}
              alt="Mesh Representation"
              caption="Figure 9. Mesh Representation"
              onClick={() => handleImgClick(`${import.meta.env.BASE_URL}Project_01/P01_Figure_06.png`, "Mesh Representation")}
            />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-8">
            ...
            <ImgCol
              src={`${import.meta.env.BASE_URL}Project_01/P01_Figure_07.png`}
              alt="Fixed Boundary Condition"
              caption="Figure 10. Fixed Boundary Condition"
              onClick={() => handleImgClick(`${import.meta.env.BASE_URL}Project_01/P01_Figure_07.png`, "Fixed Boundary Condition")}
            />
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-8">
            <div>
            ...
            <ImgCol
              src={`${import.meta.env.BASE_URL}Project_01/P01_Figure_08.png`}
              alt="UDL Condition"
              caption="Figure 11. UDL Condition"
              onClick={() => handleImgClick(`${import.meta.env.BASE_URL}Project_01/P01_Figure_08.png`, "UDL Condition")}
            />
          </div>
        </section>
        ...
        <section className="w-full mb-8 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl shadow-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-8">
            ...
            <ImgCol
              src={`${import.meta.env.BASE_URL}Project_01/P01_Figure_09.png`}
              alt="Total Deformation of the Assembly"
              caption="Figure 12. Total Deformation of the Assembly"
              onClick={() => handleImgClick(`${import.meta.env.BASE_URL}Project_01/P01_Figure_09.png`, "Total Deformation of the Assembly")}
            />
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-8">
            <ImgCol
              src={`${import.meta.env.BASE_URL}Project_01/P01_Figure_10.png`}
              alt="Deformation of Anchor"
              caption="Figure 13. Deformation of Anchor"
              onClick={() => handleImgClick(`${import.meta.env.BASE_URL}Project_01/P01_Figure_10.png`, "Deformation of Anchor")}
            />
            <ImgCol
              src={`${import.meta.env.BASE_URL}Project_01/P01_Figure_11.png`}
              alt="Deformation of Outer Wedge"
              caption="Figure 14. Deformation of Outer Wedge"
              onClick={() => handleImgClick(`${import.meta.env.BASE_URL}Project_01/P01_Figure_11.png`, "Deformation of Outer Wedge")}
            />
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-8">
            <ImgCol
              src={`${import.meta.env.BASE_URL}Project_01/P01_Figure_12.png`}
              alt="Deformation of Inner Wedge"
              caption="Figure 15. Deformation of Inner Wedge"
              onClick={() => handleImgClick(`${import.meta.env.BASE_URL}Project_01/P01_Figure_12.png`, "Deformation of Inner Wedge")}
            />
            <ImgCol
              src={`${import.meta.env.BASE_URL}Project_01/P01_Figure_13.png`}
              alt="Deformation of Cable"
              caption="Figure 16. Deformation of Cable"
              onClick={() => handleImgClick(`${import.meta.env.BASE_URL}Project_01/P01_Figure_13.png`, "Deformation of Cable")}
            />
          </div>
          {/* 5.2 Stress */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-8">
            ...
            <ImgCol
              src={`${import.meta.env.BASE_URL}Project_01/P01_Figure_14.png`}
              alt="Stress Distribution of the Assembly"
              caption="Figure 17. Stress Distribution of the Assembly"
              onClick={() => handleImgClick(`${import.meta.env.BASE_URL}Project_01/P01_Figure_14.png`, "Stress Distribution of the Assembly")}
            />
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-8">
            <ImgCol
              src={`${import.meta.env.BASE_URL}Project_01/P01_Figure_15.png`}
              alt="Stress Distribution of Anchor"
              caption="Figure 18. Stress Distribution of Anchor"
              onClick={() => handleImgClick(`${import.meta.env.BASE_URL}Project_01/P01_Figure_15.png`, "Stress Distribution of Anchor")}
            />
            <ImgCol
              src={`${import.meta.env.BASE_URL}Project_01/P01_Figure_16.png`}
              alt="Stress Distribution of Outer Wedge"
              caption="Figure 19. Stress Distribution of Outer Wedge"
              onClick={() => handleImgClick(`${import.meta.env.BASE_URL}Project_01/P01_Figure_16.png`, "Stress Distribution of Outer Wedge")}
            />
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-8">
            <ImgCol
              src={`${import.meta.env.BASE_URL}Project_01/P01_Figure_17.png`}
              alt="Stress Distribution of Inner Wedge"
              caption="Figure 20. Stress Distribution of Inner Wedge"
              onClick={() => handleImgClick(`${import.meta.env.BASE_URL}Project_01/P01_Figure_17.png`, "Stress Distribution of Inner Wedge")}
            />
            <ImgCol
              src={`${import.meta.env.BASE_URL}Project_01/P01_Figure_18.png`}
              alt="Stress Distribution of Cable"
              caption="Figure 21. Stress Distribution of Cable"
              onClick={() => handleImgClick(`${import.meta.env.BASE_URL}Project_01/P01_Figure_18.png`, "Stress Distribution of Cable")}
            />
          </div>
        </section>
      </div>
